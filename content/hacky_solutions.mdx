...
If your school is blocking all `hackclub.com` websites, this may be a solution for you. `bulckcah.com` is a proxy serving many Hack Club websites including the main Hack Club website at https://bulckcah.com, workshops at https://workshops.bulckcah.com, among others. To make a `hackclub.com` website accessible through this proxy, make a pull request in the [hackclub/proxyparty](https://github.com/hackclub/proxyparty) repository on GitHub.
