...
If your school's disciplinary policies are compatible with this, this is a simple solution.

If you or your club members happen to be on Macs and pay for iCloud storage(iCloud+), Safari has a built in "proxy" called Private Relay.
